...
def upgrade() -> None:
    ...
    op.create_table("event_recurring_rules",
    ...
    sa.ForeignKeyConstraint(["event_id"], ["events.id"], name=op.f("fk_event_recurring_rules_event_id_events"), ondelete="CASCADE"),
    ...
    op.alter_column("release_files", "sha256_sum",
