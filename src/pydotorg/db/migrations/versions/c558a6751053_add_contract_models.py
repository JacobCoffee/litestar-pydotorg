...
def upgrade() -> None:
    ...
    op.create_table("sponsor_legal_clauses",
    ...
    sa.Column("status", sa.Enum("draft", "outdated", "awaiting_signature", "executed", "nullified", name="contractstatus"), nullable=False),
    ...
    sa.ForeignKeyConstraint(["sponsorship_id"], ["sponsorships.id"], name=op.f("fk_sponsor_contracts_sponsorship_id_sponsorships"), ondelete="CASCADE"),
