...
async def _create_page_via_db(session_factory: async_sessionmaker, **page_data: object) -> dict:
    """Create a page directly in the database using shared session factory."""
...
async def _create_image_via_db(session_factory: async_sessionmaker, page_id: str, **image_data: object) -> dict:
    """Create an image directly in the database using shared session factory."""
    async with session_factory() as session:
...
async def _create_document_via_db(session_factory: async_sessionmaker, page_id: str, **doc_data: object) -> dict:
    """Create a document directly in the database using shared session factory."""
    async with session_factory() as session:
        from uuid import UUID as PyUUID
...
class TestPageControllerRoutes:
    ...
    async def test_list_pages_with_pagination(self, pages_fixtures: PagesTestFixtures) -> None:
        ...
        for i in range(3):
            await _create_page_via_db(
                pages_fixtures.session_factory,
                title=f"Page {i}",
    ...
    async def test_get_page_by_id(self, pages_fixtures: PagesTestFixtures) -> None:
        ...
        page = await _create_page_via_db(pages_fixtures.session_factory, title="Get Test Page")
    ...
    async def test_update_page(self, pages_fixtures: PagesTestFixtures) -> None:
        ...
        page = await _create_page_via_db(pages_fixtures.session_factory, title="Original Title")
        update_data = {
            "title": "Updated Title",
    ...
    async def test_delete_page(self, pages_fixtures: PagesTestFixtures) -> None:
        ...
        page = await _create_page_via_db(pages_fixtures.session_factory, title="To Delete")
...
class TestImageControllerRoutes:
    ...
    async def test_list_images_with_pagination(self, pages_fixtures: PagesTestFixtures) -> None:
        ...
        page = await _create_page_via_db(pages_fixtures.session_factory, title="Image Test Page")
        for i in range(3):
    ...
    async def test_create_image(self, pages_fixtures: PagesTestFixtures) -> None:
        ...
        page = await _create_page_via_db(pages_fixtures.session_factory, title="Image Page")
        image_data = {
            "page_id": page["id"],
    ...
    async def test_get_image_by_id(self, pages_fixtures: PagesTestFixtures) -> None:
        ...
        page = await _create_page_via_db(pages_fixtures.session_factory, title="Image Get Page")
        image = await _create_image_via_db(pages_fixtures.session_factory, page["id"])
    ...
    async def test_delete_image(self, pages_fixtures: PagesTestFixtures) -> None:
        ...
        page = await _create_page_via_db(pages_fixtures.session_factory, title="Image Delete Page")
        image = await _create_image_via_db(pages_fixtures.session_factory, page["id"])
...
class TestDocumentFileControllerRoutes:
    ...
    async def test_list_documents_with_pagination(self, pages_fixtures: PagesTestFixtures) -> None:
        ...
        page = await _create_page_via_db(pages_fixtures.session_factory, title="Doc Test Page")
        for i in range(3):
    ...
    async def test_create_document(self, pages_fixtures: PagesTestFixtures) -> None:
        ...
        page = await _create_page_via_db(pages_fixtures.session_factory, title="Doc Page")
        doc_data = {
            "page_id": page["id"],
    ...
    async def test_get_document_by_id(self, pages_fixtures: PagesTestFixtures) -> None:
        ...
        page = await _create_page_via_db(pages_fixtures.session_factory, title="Doc Get Page")
        document = await _create_document_via_db(pages_fixtures.session_factory, page["id"])
    ...
    async def test_delete_document(self, pages_fixtures: PagesTestFixtures) -> None:
        ...
        page = await _create_page_via_db(pages_fixtures.session_factory, title="Doc Delete Page")
        document = await _create_document_via_db(pages_fixtures.session_factory, page["id"])
